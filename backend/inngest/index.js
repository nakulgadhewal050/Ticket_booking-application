...
// Ingest function to cancel booking and release seats of show after 10 minutes of booking if payment is not completed
...
// Ingest funtion to send email when user books a show
  ...
  async ({ step }) => {
    ...
    const reminderTasks = await step.run("prepare-reminder-tasks", async () => {
      const shows = await Show.find({
        showTime: { $gtr: windowStart, $lte: in8Hours },
      }).populate('movie');
    ...
    <p>
      ...
      <strong>8 hours</strong> — make sure you're ready!
    </p>
