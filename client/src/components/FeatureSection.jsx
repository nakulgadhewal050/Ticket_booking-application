    ...
    return (
        <div className='px-6 md:px-16 lg:px-24 xl:px-44 overflow-hidden'>
            <div className='relative flex items-center justify-between pt-20 pb-10'>
                ...
                <button className='group flex items-center gap-2 text-sm text-gray-300 cursor-pointer'
                    onClick={() => navigate('/movies')}>
                    View All
                    <ArrowRightIcon className='group-hover:translate-x-0.5 transition w-4.5 h-4.5' /></button>
            </div>
